...
import LatestProjects from '../Components/recentProject'


export default function page() {
  return (
    <div className='flex flex-col justify-center items-center bg-background w-full h-[auto] relative'>

    <div className="navBar absolute top-0 left-0 flex w-full py-3   justify-center">
    ...
    <h1 className='text-[80px] text-fontcolor'>Project Page</h1>
