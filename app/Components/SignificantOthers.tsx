...
export default function SignificantOthers() {
  ...
  return (
    <section className="bg-cardbg py-16 px-6 md:px-16 w-[96%] rounded-2xl">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="w-full">
          <h2 className="text-4xl font-bold mb-6 text-fontcolor">Significant others.</h2>
          <div className="space-y-4">
            {[
              ...
              { key: "ipad-iphone", title: "Education and Qualifications", content: "iPad is a great way to optimize your workouts while tracking your progress on Apple Watch. See personal metrics from Apple Watch integrated on the screen of your iPad in real time. The sensors in Apple Watch combine with advanced algorithms to provide data that keeps you motivated. And see it all come together on your Health app on iPad." },
              { key: "ipad-mac", title: "Work Experiences", content: "iPad is a great way to optimize your workouts while tracking your progress on Apple Watch. See personal metrics from Apple Watch integrated on the screen of your iPad in real time. The sensors in Apple Watch combine with advanced algorithms to provide data that keeps you motivated. And see it all come together on your Health app on iPad." },
              { key: "ipad", title: "Work Experiences", content: "iPad is a great way to optimize your workouts while tracking your progress on Apple Watch. See personal metrics from Apple Watch integrated on the screen of your iPad in real time. The sensors in Apple Watch combine with advanced algorithms to provide data that keeps you motivated. And see it all come together on your Health app on iPad." },
            ].map(({ key, title, content }) => (
              <div key={key} className="p-4 border-t">
                <button onClick={() => toggleSection(key)} className="cursor-pointer text-lg font-semibold w-full flex justify-between items-center text-left text-fontcolor">
                  {title}
                ...
                <AnimatePresence>
                  {openSection === key && (
                    <motion.p
                      ...
                      className="mt-2 text-bodytext overflow-hidden"
                    >
                      {content}
                    </motion.p>
                  )}
